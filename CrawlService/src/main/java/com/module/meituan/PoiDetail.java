...
import com.module.meituan.Params.PoiDetailParam;
...
public class PoiDetail {
	...
	* @throws 
	*/
	public static void mt_test_detail() {
		PoiDetailParam menuParam = new PoiDetailParam();
		...
		RequestBean poiRequest = getPoiDetail(menuParam);
	...
	public static void mt_getdetail() {
		try {
			String requestUrl  = "http://wmapi.meituan.com/api/v6/poi/info?utm_medium=android&utm_content=867981023009148&utm_term=60607&utm_source=1040&ci=30&utm_campaign=AwaimaiBwaimaiGhomepage&uuid=4A246A75A4E27F91C6F526C90A1691FC5422ED28653C89E2BB69685D9C8663FE&__skck=6a375bce8c66a0dc293860dfa83833ef&__skts=1557047919660&__skua=d41d8cd98f00b204e9800998ecf8427e&__skno=c210deed-7c95-4f1f-9a1a-31fbf42fe217&__skcy=4g5oa7cNF%2Btdr5jeEAcRttFRdSg%3D";
			String requestBody = "wmpoiid=2991821&wm_latitude=22540640&wm_logintoken=&wm_mac=02%3A00%3A00%3A00%3A00%3A00&request_id=AD08072A-7761-462B-8202-0871D7CEA8F7&poilist_mt_cityid=30&uuid=4A246A75A4E27F91C6F526C90A1691FC5422ED28653C89E2BB69685D9C8663FE&wm_actual_longitude=113940004&wm_actual_latitude=22539913&wm_ctype=android&app=4&wm_visitid=10585585-a832-451a-970e-68c7b4d962da&wm_did=867981023009148&userid=0&platform=4&seq_id=1697&wm_dversion=23_6.0&wm_longitude=113939945&wm_channel=1040&wm_uuid=4A246A75A4E27F91C6F526C90A1691FC5422ED28653C89E2BB69685D9C8663FE&wm_dtype=Nexus+6P&poilist_wm_cityid=440300&version=6.6.7&push_token=dpshad82ca16853387c8caf8b2db308941e2atpu&partner=4&wm_appversion=6.6.7&waimai_sign=PQ0stR2rEHKsjYBOPSNgkBQzohikg1YorZwl46X1VSGE0JnQMNhWFGBExGqQsxOADNh1gZW8wR3Wqr6DHKeM8CMjvKLmUWuP7osk8RQjE%2FyDPY%2FcamdTbu6Mtw5R%2F3n9sIofUulHs5EvgNewn7A7hwPQk8Yy%2FCPTx4p%2FM8GnJ2A%3D&wm_seq=104&req_time=1557047919651";
	...
	* @param ${params} PoiDetai请求的参数
	* @return ${RequestBean)请求
	* @throws 
	*/
	public static RequestBean getPoiDetail(PoiDetailParam params) {
		String api = "wmapi.meituan.com/api/v6/poi/info";
		String url = "http://"+api;
